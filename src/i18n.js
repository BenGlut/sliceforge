const dict = {
  ...
  fr: {
    ...
    previewPins: 'Voir les tenons',
    pinsEditHint: 'Glisse un tenon pour le déplacer, clique-le pour le retirer, clique un plan pour en ajouter.',
    ...
    placePins: 'Placer les tenons à la main',
    pinsHint: 'Les pièces deviennent transparentes — clique le plan à travers la matière pour poser un tenon, reclique-le pour le retirer. Ils suivent le plan.',
    pinsPlaced: '{{n}} posé(s)',
    clearPins: 'Effacer',
    dimensions: 'Dimensions (mm)',
